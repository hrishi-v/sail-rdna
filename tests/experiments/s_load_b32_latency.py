...
POISON         = 0x11111111
N_MAX          = 80
SNOP_CROSSOVER = 46  # measured reference: 1 cycle per s_nop 0 iteration

# ---------------------------------------------------------------------------
# Fill type definitions: (display_label, slug, gen_fn)
# gen_fn(n) -> list of asm instruction strings for n iterations
# ---------------------------------------------------------------------------
...
def _probe(slug: str, instrs: list[str]) -> bool:
    ...
    name          = f"smem_{slug}_{len(instrs):04d}"
